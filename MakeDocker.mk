...
dockerTestRunLatest:
	...
	# docker run -it -d --entrypoint /bin/sh --name ${INFO_TEST_TAG_BUILD_CONTAINER_NAME} ${INFO_BUILD_DOCKER_SOURCE_IMAGE}:${INFO_BUILD_DOCKER_TAG}
...
dockerTestRmiLatest:
	...
	INFO_BUILD_DOCKER_SOURCE_IMAGE=$(INFO_BUILD_DOCKER_SOURCE_IMAGE) \
