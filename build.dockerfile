...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov/filebrowser-client
ARG GO_ENV_ROOT_BUILD_BIN_NAME=filebrowser-client
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/filebrowser-client/main.go
